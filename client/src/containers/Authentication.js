...
const Authentication = () => {
    ...
    return (
        <div class="min-h-screen flex flex-col items-center  bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <p class="text-center p-5"><Link to={`${url}/login`} class="font-medium text-indigo-600 hover:text-indigo-500">Login</Link> or <Link to={`${url}/signup`} class="font-medium text-indigo-600 hover:text-indigo-500">Signup</Link></p>
